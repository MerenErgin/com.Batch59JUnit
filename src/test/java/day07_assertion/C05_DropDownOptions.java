...
public class C05_DropDownOptions {
    ...
    public void test01(){
        ...
        //bir ddropdown ile calisiyorken, son secilen optiona ulasmak isterseniz
        //select.getFirstSelectedOption().getText() methodunu kullanmalisiniz
        // bu method bize WebElement dondurur,
        // uzerindeki yaziyi yazdirmak icin getText() unutulmamalidir
        System.out.println(select.getFirstSelectedOption().getText());

        //dropdown'daki opsiyonlarin toplam sayisini 28 oldugunu test edin
