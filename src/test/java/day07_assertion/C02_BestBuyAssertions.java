 ...
 */
    ...
    public void test03(){
        //○ logoTest => BestBuy logosunun görüntülendigini test edin
        WebElement logoElemnti= driver.findElement(By.xpath("//img[@class='logo'][1]"));
    ...
    public void test04(){
        //○ FrancaisLinkTest => Fransizca Linkin görüntülendiğini test edin
        WebElement fraincaisElementi= driver.findElement(By.xpath("//*[text()='Français']"));
        Assert.assertTrue(fraincaisElementi.isDisplayed());
    }
}
